                                      ...
                                      Padding(
                                        ...
                                        child: Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                                controller.leaveHeaderList.isNotEmpty ? controller.leaveHeaderList[0].department.toString() : '--:--',
                                                style: AppStyle.plus500.copyWith(
                                        ...
                                        Padding(
                                          ...
                                          child: Align(
                                            ...
                                            child: Padding(
                                              padding: const EdgeInsets.all(10),
                                              child: Text(
                                                  controller.leaveHeaderList.isNotEmpty ? controller.leaveHeaderList[0].deptInc.toString() : '--:--',
                                                  style: AppStyle.plus500.copyWith(
                                                    fontSize: controller.getResponsiveFontSize(context, 20),
                                                  )),
                                            ),
                                      ...
                                      Padding(
                                        ...
                                        child: Align(
                                          ...
                                          child: Padding(
                                            padding: const EdgeInsets.all(10),
                                            child: Text(
                                                controller.leaveHeaderList.isNotEmpty ? controller.leaveHeaderList[0].deptHOD.toString() : '--:--',
                                                style: AppStyle.plus500.copyWith(
                                                  fontSize: controller.getResponsiveFontSize(context, 20),
                                                )),
                                          ),
                                      ...
                                      Padding(
                                        ...
                                        child: Align(
                                          ...
                                          child: Padding(
                                            padding: const EdgeInsets.all(10),
                                            child: Text(
                                                controller.leaveHeaderList.isNotEmpty ? controller.leaveHeaderList[0].subDept.toString() : '--:--',
                                                style: AppStyle.plus500.copyWith(
                                                  fontSize: controller.getResponsiveFontSize(context, 20),
                                                )),
                                          ),
                                      ...
                                      Padding(
                                        ...
                                        child: Align(
                                          ...
                                          child: Padding(
                                            padding: const EdgeInsets.all(10),
                                            child: Text(
                                                controller.leaveHeaderList.isNotEmpty ? controller.leaveHeaderList[0].subDeptInc.toString() : '--:--',
                                                style: AppStyle.plus500.copyWith(
                                                  fontSize: controller.getResponsiveFontSize(context, 20),
                                                )),
                                          ),
