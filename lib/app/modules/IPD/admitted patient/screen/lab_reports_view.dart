...
import 'package:schoolapp/app/modules/IPD/admitted%20patient/widgets/ref.dart';
import 'package:schoolapp/app/modules/IPD/admitted%20patient/widgets/start_heading.dart';
...
class LabReportsView extends StatelessWidget {
  ...
  String ipdNo = '';
  String uhidNo = '';
  LabReportsView({super.key, required this.patientName, required this.bedNumber, required this.ipdNo, required this.uhidNo});
  @override
                ...
                ? Column(children: [
                    AppBar(
                      title: AppText(
                        text: 'Lab Reports',
                        fontSize: Sizes.px22,
                        fontColor: AppColor.headingTexColor,
                        ...
                        children: [
                          ...
                          Expanded(
                            child: RefreshIndicator(
                              onRefresh: () async {
                                await controller.getLabReporst(ipdNo: ipdNo, uhidNo: uhidNo, isLoader: false);
                              },
                              child: Padding(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      decoration: BoxDecoration(
                                        ...
                                        border: Border.all(
                                          width: 1,
                                          color: AppColor.black6B6B6B.withOpacity(0.20),
                                        ),
                                      ),
                                      child: Padding(
                                        padding: EdgeInsets.symmetric(
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: GestureDetector(
                                                      onTap: () {
                                                        if (controller.dataContain.contains(controller.commonList[index]['report_name'])) {
                                                          controller.dataContain.remove(controller.commonList[index]['report_name']);
                                                        } else {
                                                          controller.dataContain = [];
                                                          controller.dataContain.add(controller.commonList[index]['report_name']);
                                                        }
                                                        controller.update();
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    Expanded(
                                                                      child: AppText(
                                                                        text: controller.commonList[index]['report_name'] ?? "",
                                                                        fontSize: Sizes.px14,
